...
import { saveCompletedReading, getCompletedReading, getCompletedReadingById, updateCompletedReading, deleteCompletedReading } from "../controllers/results.controller";
